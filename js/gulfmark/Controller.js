...
$.ajax(
    {
        ...
        url: "http://50.194.79.186:8080/sap/inv/opu/odata/sap/Z_INTERNAL_APPS_SRV/z_get_polist/?$filter=Username eq '"+username+"' and Value eq '002'",
        type: 'GET',
        contentType: "application/xml;charset=utf-8",
        dataType: "",
        cache: false,
...
$.ajax(
    {
        //url: "http://50.194.79.186:8080/sap/inv/opu/odata/sap/ZPO_CM_APPROVAL/zpo_approvalCollection?$filter=username%20eq'"+username+"'",
        url: "http://50.194.79.186:8080/sap/inv/opu/odata/sap/Z_INTERNAL_APPS_SRV/z_get_polist/?$filter=Username eq '"+username+"' and Value eq '003'",
        type: 'GET',
        contentType: "application/xml;charset=utf-8",
        dataType: "",
        cache: false,
